...
from django.db.models import Model, CharField, CASCADE, DateTimeField, ForeignKey, \
    ManyToManyField, ImageField, FloatField, PositiveIntegerField
...
class Blog(Model):
    ...
    def save(self, forse_insert=False, forse_update=False , using=None, update_fields=None):
        super().save(forse_insert, forse_update , using, update_fields)
